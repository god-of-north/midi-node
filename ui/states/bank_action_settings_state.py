...
class BankActionSettingsState(MenuState):
    """
    Settings menu for editing Bank Enter/Exit actions.
    Same style as PresetActionSettingsState but operates on Bank.enter_action / exit_action.
    """
    ...
    def on_enter(self):
        ...
        action: Action = bank.enter_action if self.is_enter else bank.exit_action
        if not action:
